...
# Integrate HCE with Google Cloud Build
...
## Why integrate HCE with Google Cloud Build? <a href="#why-integrate-hce-with-google-cloud-build" id="why-integrate-hce-with-google-cloud-build"></a>
...
* [Harness API key](https://developer.harness.io/harness-platform/use-harness-platform/automation/api/add-and-manage-api-keys#create-personal-api-keys-and-tokens) is required for authentication, which is passed as a secret to the YAML file.

## Steps to Integrate Harness Chaos Engineering with Google Cloud Build <a href="#steps-to-integrate-harness-chaos-engineering-with-google-cloud-build" id="steps-to-integrate-harness-chaos-engineering-with-google-cloud-build"></a>

1. [Set up a chaos experiment based on your application's requirements](../../chaos-testing/experiments/): After saving the experiment, copy the experiment ID and choose a value for the `expected-resilience-score`.
...
After the chaos experiment is triggered through Google Cloud Build, you can monitor its progress (see Experiments documentation) and results within the Harness UI.
