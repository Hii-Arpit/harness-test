...
To switch and use, jump directly to [Switching between Cost Explorer and Perspectives](/broken/pages/73b4c5f121749a2f2ccf3ee0f4d143008f786014#switching-between-cost-explorer-and-perspectives).
...
Click **"add advanced filter"** o the filter chip to open the drawer.
{% endstep %}

{% step %}
## Add conditions

Add conditions using the field selector and operator dropdown.
{% endstep %}

{% step %}
## Add conditions within a rule

Add multiple conditions within a rule (AND logic).
{% endstep %}

{% step %}
## Add rules

Add multiple rules (OR logic between rules).
{% endstep %}
...
Check [Unit Cost Metrics](/broken/pages/ef7608c419d7f6ed8d32ee491a1e389386d59b0a) documentation for more details.
...
Open a Perspective in **Cost Explorer**.
{% endstep %}

{% step %}
## Open the Unit Costs picker

In the toolbar, look for the **Unit Costs (N)** picker next to filters.
{% endstep %}

{% step %}
## Add and configure a metric

Click **+ Add Unit Cost** and configure the metric:
...
**Apply** the metric. It appears immediately as a chart overlay and summary card.
{% endstep %}

{% step %}
## Save the view

Click **Save view** to persist the metric set with the Perspective.
{% endstep %}
{% endstepper %}
...
* **Metric** — Select a registered business metric from the list. The metric's default aggregation is used unless overridden. This kind references a **business metric** you've already registered under **Cloud Integrations → Unit Cost**. (See the [separate setup guide](/broken/pages/ef7608c419d7f6ed8d32ee491a1e389386d59b0a); Cost Explorer can only consume metrics that already exist.)
*   **Formula** — Combine multiple cost and/or metric inputs (see [Formula Rules](/broken/pages/73b4c5f121749a2f2ccf3ee0f4d143008f786014#formula-rules). Use this when no single Cost or Metric value is enough — e.g., chargeback splits, weighted blends, or "subtract one slice from another". Each input is itself an operand row and can be **Cost** or **Metric** but **not another Formula**
...
* **Cost Categories**: You can create a perspective by filtering based on the cost categories you have created. To create cost categories, see [Use Cost Categories](/broken/pages/8a0ee5d0628e8379c27d814c4148de5e9da25581).
* **Generic**:
...
* **Label V2**: Preserves the original structure from AWS similar to how GCP, Azure and Cluster tags are stored. See [Understanding the Difference: Label vs. Label V2](/broken/pages/7a2b9a81ff0f7244b07d298bbccd6cdca45855e6#understanding-the-difference-label-vs-label-v2-and-migration) and [Migrate from Label to Label V2](/broken/pages/7a2b9a81ff0f7244b07d298bbccd6cdca45855e6#migration-from-label-to-label-v2).
...
* [AWS Preferences](/broken/pages/0943b5641f072f4cea3e9dfefb02728465962532)
* [GCP Preferences](/broken/pages/0943b5641f072f4cea3e9dfefb02728465962532)
* [Azure Preferences](/broken/pages/0943b5641f072f4cea3e9dfefb02728465962532)
...
Apply filters, grouping, and preferences.
{% endstep %}

{% step %}
## Open the save menu

Click **"Save as View"** dropdown.
{% endstep %}

{% step %}
## Choose the save option

Choose **"Save"** (update existing) or **"Save as View"** (create new).
{% endstep %}

{% step %}
## Name and organize the view

Enter view name and select folder.
{% endstep %}
...
Read More here: [Dynamic Cost Categories Toggle](/broken/pages/7a2b9a81ff0f7244b07d298bbccd6cdca45855e6#dynamic-cost-categories-toggle)
...
Look for the **"Switch to new Views Experience"** banner on the Perspectives page.
{% endstep %}

{% step %}
## Switch

Click **"Switch"** to enable Cost Explorer.
{% endstep %}

{% step %}
## Reload

The page will reload with the new interface.
{% endstep %}
{% endstepper %}
...
{% stepper %}
{% step %}
## Open the Views Explorer Drawer

Open the **Views Explorer Drawer** (click the View selector).
{% endstep %}

{% step %}
## Switch back

Click **"Switch back to Perspectives"** link in the header.
{% endstep %}

{% step %}
## Reload

The page will reload with the classic Perspectives interface.
{% endstep %}
{% endstepper %}
