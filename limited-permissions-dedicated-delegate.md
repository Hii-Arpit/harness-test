...
Create the chaos infrastructure using the connector from Step 6. The form fields are identical to the [Basic install](limited-permissions-dedicated-delegate.md#basic--create-a-kubernetes-infrastructure) flow.
