...
{% stepper %}
{% step %}
## Navigate to Rules Generating Recommendations

Navigate to **Rules Generating Recommendations** > **+New Rule** to begin the process.
{% endstep %}
...
A failed status indicates one of the following scenarios:
...
<summary>Ignored Status</summary>

An ignored status indicates one of the following scenarios:
...
{% embed url="https://app.tango.us/app/embed/25a843d3-c733-4459-99f5-69558757865c" %}
