---
description: >-
  Use Harness OPA policies to enforce configuration standards on IDP catalog
  entities, environment blueprints, environments, and CD pipelines.
---


# Centralized Policy Governance for IDP
...
OPA policies let you catch and block these misconfigurations before they are saved, across all teams and projects. Harness IDP integrates with [Harness OPA Governance](https://app.gitbook.com/s/3F2TpHXhur2QtQnORSM9/use-harness-platform/governance/policy-as-code/harness-governance-overview) to let you define and enforce policies on catalog entities (components, APIs, resources, and more), [environment blueprints](../../use-idp/environment-management/blueprints/env-blueprint-yaml.md), [environments](../../use-idp/environment-management/environments.md), and CD pipelines.
...
1. Familiarity with [Harness Policy As Code](https://app.gitbook.com/s/3F2TpHXhur2QtQnORSM9/use-harness-platform/governance/policy-as-code/harness-governance-overview).
2. Review the [Harness Governance Quickstart](https://app.gitbook.com/s/3F2TpHXhur2QtQnORSM9/use-harness-platform/governance/policy-as-code/harness-governance-quickstart) to set up your first policy and policy set.
3. Policies use the OPA authoring language Rego. Go to [OPA Policy Language](https://www.openpolicyagent.org/docs/policy-language) to learn the Rego language.

### Setup <a href="#setup" id="setup"></a>

#### Create a policy <a href="#create-a-policy" id="create-a-policy"></a>

<figure><img src="../../.gitbook/assets/opa-policy-create.gif" alt=""><figcaption></figcaption></figure>
...
4. In the policy editor, write your Rego policy. The policy receives the full entity payload under `input.idpEntity` for IDP entity policies, and under `input.pipeline` for CD pipeline policies. See the [Policy input schema](opa-governance.md#policy-input-schema) section for available fields.
...
{% hint style="info" %}
**DIFFERENCE BETWEEN 'POLICY' AND 'POLICY SET'**
...
<figure><img src="../../.gitbook/assets/create-policyset.gif" alt=""><figcaption></figcaption></figure>

1. On the same page as [Create a policy](opa-governance.md#create-a-policy), click the **Policy Sets** tab on the top-right.
...
5. Select the [policy you created earlier](opa-governance.md#create-a-policy).
...
### Result of policy enforcement <a href="#result-of-policy-enforcement" id="result-of-policy-enforcement"></a>
...
*   **On Catalog Entity**
    ...
    <figure><img src="../../.gitbook/assets/policyset-eval2.gif" alt=""><figcaption></figcaption></figure>
*   **On Environment**

    <figure><img src="../../.gitbook/assets/policyset-eval.gif" alt=""><figcaption></figcaption></figure>

***

### Policy input schema <a href="#policy-input-schema" id="policy-input-schema"></a>
...
### Sample policies for catalog entity <a href="#sample-policies-for-catalog-entity" id="sample-policies-for-catalog-entity"></a>

The following policies apply to catalog entities: components, APIs, resources, groups, and systems.

#### Reserved names <a href="#reserved-names" id="reserved-names"></a>
...
#### Approved lifecycle values <a href="#approved-lifecycle-values" id="approved-lifecycle-values"></a>
...
#### APIs must belong to a system <a href="#apis-must-belong-to-a-system" id="apis-must-belong-to-a-system"></a>
...
### Sample policies for environment management <a href="#sample-policies-for-environment-management" id="sample-policies-for-environment-management"></a>

The following policies apply to environment blueprints and environments.

#### Require TTL on all blueprints <a href="#require-ttl-on-all-blueprints" id="require-ttl-on-all-blueprints"></a>
...
#### Enforce a maximum TTL on blueprints <a href="#enforce-a-maximum-ttl-on-blueprints" id="enforce-a-maximum-ttl-on-blueprints"></a>
...
#### Enforce a maximum TTL on environments <a href="#enforce-a-maximum-ttl-on-environments" id="enforce-a-maximum-ttl-on-environments"></a>
...
#### Warn when blueprint TTL exceeds 3 days <a href="#warn-when-blueprint-ttl-exceeds-3-days" id="warn-when-blueprint-ttl-exceeds-3-days"></a>
...
### Sample policies for CD pipelines <a href="#sample-policies-for-cd-pipelines" id="sample-policies-for-cd-pipelines"></a>
...
IDP scorecard data is accessed in Rego via `stage.spec.idpScorecard.<serviceId>`, where `<serviceId>` is the [Harness service ID](https://app.gitbook.com/s/y1JhZ4oKIppwY7d5AhPj/new-to-continuous-delivery/overview#service) from the annotation `harness.io/cd-serviceId: <SERVICE_IDENTIFIER>` on the catalog entity. This annotation is auto-ingested if you followed the onboarding guide; otherwise add it manually to your `catalog-info.yaml`.

#### Pipeline on save, single service <a href="#pipeline-on-save-single-service" id="pipeline-on-save-single-service"></a>
...
<figure><img src="../../.gitbook/assets/opa-ss.png" alt=""><figcaption></figcaption></figure>
...
#### Pipeline on run, multiple services <a href="#pipeline-on-run-multiple-services" id="pipeline-on-run-multiple-services"></a>
...
<figure><img src="../../.gitbook/assets/opa-ms.png" alt=""><figcaption></figcaption></figure>
...
### Policy scope <a href="#policy-scope" id="policy-scope"></a>
