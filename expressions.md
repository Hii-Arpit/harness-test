---
description: >-
  Complete reference mapping built-in expressions from Harness NextGen to Harness
  3.0, new ${{ }} syntax, snake_case naming, and all expression contexts.
title: Expression Mapping
sidebar_label: Expression Mapping
sidebar_position: 7
nodeTitle: Expression Mapping
inputFilePath: 3k-docs/platform/getting-started/pipelines/expressions.md
originalUrl: >-
  https://developer.harness.io/3k-docs/platform/getting-started/pipelines/expressions/
---


# Expression Mapping

This guide provides a comprehensive mapping of built-in expressions between Harness NextGen and Harness 3.0 (Unified Pipeline). Use this reference when migrating your pipelines to the new expression syntax.

### Key syntax changes <a href="#key-syntax-changes" id="key-syntax-changes"></a>
...
When migrating pipelines from NG to 3.0, use find-and-replace to update the expression wrapper from `<+...>` to `${{ ... }}`, then update individual property names from camelCase to snake\_case. The Harness pipeline converter can handle most of these transformations automatically.
{% endhint %}

### Pipeline expressions <a href="#pipeline-expressions" id="pipeline-expressions"></a>

| Description               | Harness NextGen                                                        | Harness 3.0                                             |
| ------------------------- | ----------------------------------------------------------------- | ------------------------------------------------------- |
...
### Stage expressions <a href="#stage-expressions" id="stage-expressions"></a>
...
### Step expressions <a href="#step-expressions" id="step-expressions"></a>
...
### Service expressions <a href="#service-expressions" id="service-expressions"></a>
...
### Environment expressions <a href="#environment-expressions" id="environment-expressions"></a>
...
### Infrastructure expressions <a href="#infrastructure-expressions" id="infrastructure-expressions"></a>
...
### Artifact expressions <a href="#artifact-expressions" id="artifact-expressions"></a>
...
### Sidecar expressions <a href="#sidecar-expressions" id="sidecar-expressions"></a>
...
### Manifest expressions <a href="#manifest-expressions" id="manifest-expressions"></a>
...
### Config file expressions <a href="#config-file-expressions" id="config-file-expressions"></a>
...
### Secret expressions <a href="#secret-expressions" id="secret-expressions"></a>
...
### Trigger expressions <a href="#trigger-expressions" id="trigger-expressions"></a>
...
### Codebase expressions <a href="#codebase-expressions" id="codebase-expressions"></a>
...
### Variable expressions <a href="#variable-expressions" id="variable-expressions"></a>
