---
description: >-
  Wait for Kubernetes workloads to reach a healthy running state after a
  deployment or scale operation.
title: Kubernetes Steady State Check
sidebar_position: 6
nodeTitle: Kubernetes Steady State Check
inputFilePath: >-
  3k-docs/continuous-delivery/v1-deployments/kubernetes/step-library/k8s-steady-state-check.md
originalUrl: >-
  https://developer.harness.io/3k-docs/continuous-delivery/v1-deployments/kubernetes/step-library/k8s-steady-state-check/
---
...
### Add the Kubernetes Steady State Check step <a href="#add-the-kubernetes-steady-state-check-step" id="add-the-kubernetes-steady-state-check-step"></a>
...
### Specify workloads to watch <a href="#specify-workloads-to-watch" id="specify-workloads-to-watch"></a>
...
**Step fails with "KUBECONFIG\_PATH is required"**
...
* Go to [Kubernetes Apply](k8s-apply.md) to apply manifests before checking steady state.
* Go to [Kubernetes Scale](k8s-scale.md) to scale workloads before verifying health.
* Go to [Failure strategies](https://developer.harness.io/continuous-delivery) to configure what happens when the steady-state check fails.
