...
[**SaaS**](../troubleshooting-and-resources/on-premise-vs-saas.md#saas): Fully managed cloud service with automatic updates and scaling to help you get started quickly with minimal setup.

[**On-Premise (SMP)**](../troubleshooting-and-resources/on-premise-vs-saas.md#on-premise-self-managed-platform): Deploy in your own infrastructure for complete control.

![SaaS-and-SMP model of deployment of Harness Resilience Testing](../.gitbook/assets/deployment-models.png)

***

## Chaos execution plane <a href="#chaos-execution-plane" id="chaos-execution-plane"></a>
...
### Agentless model <a href="#agentless-model" id="agentless-model"></a>
...
![Agentless Execution Plane](../.gitbook/assets/agentless-model.png)
...
### Agent-based model <a href="#agent-based-model" id="agent-based-model"></a>
...
![Agent based Execution Plane](../.gitbook/assets/agentbased-model.png)
...
## Chaos control plane <a href="#chaos-control-plane" id="chaos-control-plane"></a>
...
### Chaos services <a href="#chaos-services" id="chaos-services"></a>
...
* A service also helps achieve service-oriented chaos. This feature support is available **ONLY** for Kubernetes targets using the agentless deployment model. The Kubernetes services on the target clusters or the execution plane are discovered by the [discovery service](../shared-capabilities/services/service-discovery.md) of the Harness platform and [application maps](../shared-capabilities/application-maps.md) are created around them. After discovery, chaos experiments are created to target the resources of these services by the control plane itself. This significantly reduces the initial learning required to get started with chaos engineering practices.
...
1. Guardrails around creating chaos agents, chaos experiments, and chaos execution policies. This is achieved through the [Harness platform RBAC policies](../shared-capabilities/rbac.md).
2. Guardrails around running chaos experiments. This is achieved through the [ChaosGuard](../shared-capabilities/governance/governance-in-execution/governance-in-execution.md).

### Construct chaos experiments <a href="#construct-chaos-experiments" id="construct-chaos-experiments"></a>
...
### ChaosHubs <a href="#chaoshubs" id="chaoshubs"></a>
...
### Orchestrate chaos experiments <a href="#orchestrate-chaos-experiments" id="orchestrate-chaos-experiments"></a>
...
## Connectivity requirements <a href="#connectivity-requirements" id="connectivity-requirements"></a>
...
![Connectivity Requirements](../.gitbook/assets/connectivity-requirements.png)
...
## Scale Harness Resilience Testing <a href="#scaling-harness-resilience-testing" id="scaling-harness-resilience-testing"></a>

For the Kubernetes targets - it is easier to onboard chaos capabilities to your applications on a new Kubernetes cluster using the agentless model. Once the [Harness delegate is deployed and configured](https://developer.harness.io/harness-platform/use-harness-platform/delegates/delegate/delegate-concepts/delegate-overview#install-a-delegate), you can onboard chaos to a new Kubernetes cluster by [adding a connector](https://developer.harness.io/harness-platform/use-harness-platform/connectors/cloud-providers/add-a-kubernetes-cluster-connector) and running an automated chaos onboarding wizard that discovers the resources and creates initial set of chaos experiments.

![Scaling with Harness Resilience Testing](../.gitbook/assets/scalingchaos.png)
