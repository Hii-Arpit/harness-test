...
sidebar_position: 5
nodeTitle: Kubernetes Delete
inputFilePath: >-
  3k-docs/continuous-delivery/v1-deployments/kubernetes/step-library/k8s-delete.md
originalUrl: >-
  https://developer.harness.io/3k-docs/continuous-delivery/v1-deployments/kubernetes/step-library/k8s-delete/
---
...
### Add the Kubernetes Delete step <a href="#add-the-kubernetes-delete-step" id="add-the-kubernetes-delete-step"></a>
...
#### Choose a deletion source <a href="#choose-a-deletion-source" id="choose-a-deletion-source"></a>
...
* Go to [Kubernetes Apply](k8s-apply.md) to apply resources before deleting them.
* Go to [Failure strategies](https://developer.harness.io/continuous-delivery) to configure what happens when the Delete step fails.
