...
<summary>Why are my savings showing as zero?</summary>
...
<summary>Why is there a delay in savings appearing?</summary>
...
<summary>Can savings ever be negative?</summary>
...
<summary>How accurate are the savings calculations?</summary>
...
<summary>What happens during cloud provider outages?</summary>
...
<summary>How do I maximize my savings?</summary>

{% stepper %}
{% step %}
## Optimize idle time settings

Set appropriate idle timeouts based on your usage patterns.
{% endstep %}

{% step %}
## Use schedules

Configure fixed schedules for predictable workloads.
{% endstep %}

{% step %}
## Enable more rules

Extend Autostopping to additional resources.
{% endstep %}

{% step %}
## Review dry run data

Use dry run mode to identify savings opportunities.
{% endstep %}

{% step %}
## Monitor regularly

Check the dashboard to identify underperforming rules.
{% endstep %}
{% endstepper %}
