---
description: >-
  Configure Kubernetes services in Harness, manifests, artifact sources,
  override files, and sidecars.
title: Kubernetes services
sidebar_position: 2
nodeTitle: Kubernetes services
inputFilePath: 3k-docs/continuous-delivery/v1-deployments/kubernetes/kubernetes-services.md
originalUrl: >-
  https://developer.harness.io/3k-docs/continuous-delivery/v1-deployments/kubernetes/kubernetes-services/
---
...
* **Kubernetes cluster access:** A running cluster that your Harness delegate can reach. Go to [Install a Kubernetes delegate](https://developer.harness.io/continuous-delivery) to set up a delegate in your cluster.
* **Source connector:** A connector to the repository or registry where your manifest files and container images are stored. Go to [Connect to a code repo](https://developer.harness.io/continuous-delivery) to set up a Git connector.
* **Harness project:** A project with CD enabled. Go to [Create organizations and projects](https://developer.harness.io/continuous-delivery) to create one.

***

### Create a Kubernetes service <a href="#create-a-kubernetes-service" id="create-a-kubernetes-service"></a>
...
### Add a manifest <a href="#add-a-manifest" id="add-a-manifest"></a>

Click **+ Add** under **Manifest** and select a manifest type.

#### K8s manifest <a href="#k8s-manifest" id="k8s-manifest"></a>
...
#### OpenShift template <a href="#openshift-template" id="openshift-template"></a>
...
### Add an additional override file <a href="#add-an-additional-override-file" id="add-an-additional-override-file"></a>
...
### Add an artifact source <a href="#add-an-artifact-source" id="add-an-artifact-source"></a>
...
{% tab title="GitHub Package Registry" %}
| Field            | Description                                                                                                                            |
| ---------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
...
Go to [Add a custom artifact source for CD](https://developer.harness.io/continuous-delivery) to configure a custom source.
{% endtab %}

{% tab title="Harness Artifact Registry" %}
...
### Add a sidecar <a href="#add-a-sidecar" id="add-a-sidecar"></a>
...
* Go to [Kubernetes deployment strategies](kubernetes-deployment-strategies/rolling.md) to configure rolling, canary, or blue-green deployments.
