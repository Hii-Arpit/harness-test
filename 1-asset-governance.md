...
{% hint style="info" %}
**Asset Governance requires writing YAML-based policies using Cloud Custodian syntax.** If you are new to YAML or Cloud Custodian, we recommend reviewing the [Cloud Custodian documentation](https://cloudcustodian.io/docs/index.html) before getting started.
{% endhint %}

***

* [**Configure CACM Connector**](../../integrations/cloud-providers/aws.md)
  * Navigate to **Setup** > **Cloud Providers** > **Add a Connector**
  * Select your cloud provider (AWS, Azure, or GCP)
  * During [connector setup](../../integrations/cloud-providers/aws.md), ensure you select **"Cloud Governance"** under **"Choose Requirements"**.
* **Verify Required Permissions**
  * Ensure your connector has [all required permissions for each cloud provider](../../resources/feature-permissions.md):
...
<figure><img src="../../.gitbook/assets/rule-overview.png" alt=""><figcaption><p>Click to view full size image</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/anatomy-of-a-rule.png" alt=""><figcaption><p>Click to view full size image</p></figcaption></figure>
...
{% tab title="Creating Rules" %}
**Create a new Rule**

* In **Harness**, go to **Cloud Costs** > **Asset Governance** > **Rules**. Select **+ New Rule**.

<figure><img src="../../.gitbook/assets/asset-governance-rule-creation.png" alt=""><figcaption><p>Click to view full size image</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/rule-new.png" alt=""><figcaption><p>Click to view full size image</p></figcaption></figure>
...
*   To delete a Rule Set, click on Delete from the vertical ellipsis menu (⋮).
    ...
    <figure><img src="../../.gitbook/assets/update-and-delete.png" alt=""><figcaption><p>Click to view full size image</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/outputterminal.png" alt=""><figcaption><p>Click to view full size image</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/ouputscreen.png" alt=""><figcaption><p>Click to view full size image</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/rule-set.png" alt=""><figcaption><p>Click to view full size image</p></figcaption></figure>
{% endtab %}

{% tab title="Creating Rule Sets" %}
...
<figure><img src="../../.gitbook/assets/create-new-rule-set.png" alt=""><figcaption><p>Click to view full size image</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/update-and-delete-ruleset.png" alt=""><figcaption><p>Click to view full size image</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/enforcement-new.png" alt=""><figcaption><p>Click to view full size image</p></figcaption></figure>

**FinOps Agent Suggested Enforcements**

<figure><img src="../../.gitbook/assets/finopsagent.png" alt=""><figcaption><p>Click to view full size image</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/finops-agent-suggestions.png" alt=""><figcaption><p>Click to view full size image</p></figcaption></figure>
{% endtab %}

{% tab title="Creating Enforcements" %}
**Create a new Enforcement**

To create an Enforcement, perform the following steps: In your **Harness** application, go to **Cloud Costs** > **Asset Governance** > **Enforcements** > **+ New Enforcement**

{% tabs %}
{% tab title="Enforcement Basics" %}
*   Enter a name for the Enforcement. Optionally, enter a description of the Enforcement. Select the cloud provider.

    <figure><img src="../../.gitbook/assets/create-enforcement-azure.png" alt=""><figcaption><p>Click to view full size image</p></figcaption></figure>
{% endtab %}

{% tab title="Rules and Rule Sets" %}
...
{% tab title="Targets and Schedule" %}
...
*   Select **Finish**.
    ...
    <figure><img src="../../.gitbook/assets/set-up-schedule-azure.png" alt=""><figcaption><p>Click to view full size image</p></figcaption></figure>
{% endtab %}
{% endtabs %}

After setting up the schedule, you can view the Enforcement on the **Enforcements** page.

<figure><img src="../../.gitbook/assets/enforcements-list.png" alt=""><figcaption><p>Click to view full size image</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/update-and-delete-enforcement.png" alt=""><figcaption><p>Click to view full size image</p></figcaption></figure>
{% endtab %}
{% endtabs %}
{% endtab %}
...
<figure><img src="../../.gitbook/assets/evaluations-azure.png" alt=""><figcaption><p>Click to view full size image</p></figcaption></figure>
...
5. Select the rule for which you want to view the Evaluation details. The target subscription, region, identified resources and evaluation logs are displayed.
...
<figure><img src="../../.gitbook/assets/evaluations-azure-table.png" alt=""><figcaption><p>Click to view full size image</p></figcaption></figure>
{% endtab %}
{% endtabs %}

***

### Cost Correlation <a href="#cost-correlation" id="cost-correlation"></a>
...
#### Cost Impact/Cost Co-relation <a href="#cost-impactcost-co-relation" id="cost-impactcost-co-relation"></a>
...
<figure><img src="../../.gitbook/assets/filter-evalaution-rules.png" alt=""><figcaption><p>Click to view full size image</p></figcaption></figure>
...
#### Bulk Export Evaluations <a href="#bulk-export-evaluations" id="bulk-export-evaluations"></a>
...
<figure><img src="../../.gitbook/assets/bulk-export.png" alt=""><figcaption><p>Click to view full size image</p></figcaption></figure>
